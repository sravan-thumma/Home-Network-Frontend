...
export class UpdateTransactionComponent implements OnInit {
  ...
  localuserid!:number;
  userid!:number;
  constructor(private router:Router,private expensesservice:ExpensesService,private route:ActivatedRoute){}
  ngOnInit(): void {
  ...
  updateTransaction(){
    this.expensesservice.updateTransaction(this.transactionid,this.trans).subscribe(
